                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slides[<%- slideNumber %>][caption_1]" class="form-control"
                                        id="slides-<%- slideNumber %>-caption-1" value="<%- slide.caption_1 %>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slides[<%- slideNumber %>][caption_2]" class="form-control"
                                        id="slides-<%- slideNumber %>-caption-2" value="<%- slide.caption_2 %>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="slides[<%- slideNumber %>][direction]" class="form-control"
                                        id="slides-<%- slideNumber %>-direction" value="<%- slide.direction %>">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slides[<%- slideNumber %>][call_to_action_text]"
                                        class="form-control" id="slides[<%- slideNumber %>][call-to-action-text]"
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slides[<%- slideNumber %>][call_to_action_url]"
                                        class="form-control" id="slides-<%- slideNumber %>-call-to-action-url"
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="checkbox">
                                    ...
                                    <input type="checkbox" name="slides[<%- slideNumber %>][open_in_new_window]"
                                        value="1" id="slides-<%- slideNumber %>-open-in-new-window"
                    ...
                    <div id="slider-<%- slideNumber %>-options" class="tab-pane fade in clearfix">
                        <select class="change-option-block custom-select-black pull-right">
                            <option value="caption-1" selected>{{ trans('slider::sliders.slide.form.caption_1') }}
                            </option>
                            <option value="caption-2">{{ trans('slider::sliders.slide.form.caption_2') }}</option>
                            <option value="call-to-action">{{ trans('slider::sliders.slide.form.call_to_action') }}
                            </option>
                        </select>
