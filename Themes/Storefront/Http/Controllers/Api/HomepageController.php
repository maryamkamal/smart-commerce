...
class HomepageController
{
    ...
    /****************************** get images for two banners ***************/
     public function getTwoBanners()
    {
       $banners = $this->getTwoColumnBanners();

        return \response()->json($banners);
    }
    
   public function getTwoColumnBanners()
    {
        return [
    ...
    /******************* end of banners methodes ****/
    public function getBrandsLogos()

    {

        $brands = Brand::with('products','files')->paginate(8);
        $data = [];
        if($brands){
            $count = 0;
