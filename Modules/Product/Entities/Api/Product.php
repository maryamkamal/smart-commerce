...
use Modules\Product\Entities\Api\File;
...
use Modules\Product\Entities\Api\Category;
use Modules\Product\Admin\ProductTable;
use Modules\Support\Eloquent\Sluggable;
use Modules\Product\Entities\Api\FlashSale;
...
class Product extends Model
{
    ...
    protected $appends = [
        ...
        'is_new', 'has_percentage_special_price', 'special_price_percent',//'wishlisted'
    ];
    ...
    public function getWishlistedAttribute() {
        if(request()->header('api_token')){
            $current = User::where('api_token',request()->header('api_token'))->first();
            $wishlisted = $current->wishlistHas($this->getKey());
            return $wishlisted;
        }
